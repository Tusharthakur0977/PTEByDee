                  ...
                  <div className="space-y-3">
                    <div>
                      <h3 className="text-2xl font-semibold tracking-tight text-slate-900 dark:text-slate-50">
                        Summarize Written Text Analysis
                      </h3>
                      <p className="mt-1 max-w-2xl text-sm text-slate-600 dark:text-slate-400">
                        Review your summary's content, form, grammar, and vocabulary feedback in detail.
                      </p>
                    </div>
                    ...
                    {isNonEmptyString(userAnswer) && writingErrors.length > 0 ? (
                      <div className="space-y-3">
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                          Incorrect words are marked with a line-through, and correct suggestions are displayed next to them in green.
                        </p>
                      </div>
                    ) : (
