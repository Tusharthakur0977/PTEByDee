                  ...
                  <div className="space-y-3">
                    <div>
                      <h3 className="text-2xl font-semibold tracking-tight text-slate-900 dark:text-slate-50">
                        MCQ Single Answer Analysis
                      </h3>
                      <p className="mt-1 max-w-2xl text-sm text-slate-600 dark:text-slate-400">
                        Review your choice and compare it with the correct answer.
                      </p>
                    </div>
                      ...
                      response.isCorrect 
                       ...
                       <div className="mb-4 flex items-center justify-between">
                          <div className="flex items-center gap-2">
                             ...
                             <span className="font-semibold text-slate-900 dark:text-slate-50">Your Choice</span>
                          </div>
                       ...
                       <p className="text-sm text-slate-700 dark:text-slate-300 italic leading-relaxed">
                          {displaySelectedAnswers[0] || "No option selected."}
                       </p>
                    </div>

                    {/* Correct Option (if incorrect) */}
                    {!response.isCorrect && displayCorrectAnswers.length > 0 && (
                      <div className="rounded-2xl border border-emerald-200 bg-emerald-50/30 p-5 dark:border-emerald-500/10 dark:bg-emerald-500/5">
                ...
                <div className="mb-5 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700/70 dark:text-amber-400/70">
                      Understand the logic behind the correct option.
                    </p>
                  </div>
                </div>
