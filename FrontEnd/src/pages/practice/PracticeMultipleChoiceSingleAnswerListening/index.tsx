...
const PracticeMultipleChoiceSingleAnswerListening: React.FC = () => {
          ...
          <div>
            ...
            <div className='flex flex-row items-center space-x-3 '>
              <p className='font-bold text-blue-600 dark:text-blue-400 text-sm leading-relaxed'>
                Listen to the recording and answer the question by selecting the
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              ...
              {!isCompleted && (
                <button
                  ...
                  disabled={!response.selectedOption || isSubmitting}
                            ...
                            <div className='flex items-center gap-2'>
                              ...
                              <div className='relative group inline-flex items-center'>
                                ...
                                <div className='absolute left-full top-1/2 ml-3 -translate-y-1/2 w-64 p-3 bg-gray-900 text-white text-xs rounded-xl shadow-xl hidden group-hover:block z-50'>
                                  ...
                                  <p>
                                    Your response for Multiple Choice, Single
                                    Answer is judged on your ability to analyze,
                                    interpret, and evaluate a brief audio or
                                    video recording on an academic subject. Your
                                    response is scored as either correct or
                                    incorrect. No credit is given for no
...
export default PracticeMultipleChoiceSingleAnswerListening;
