          ...
          <div className="flex items-start justify-between gap-4 border-b border-gray-200 px-6 py-4 dark:border-gray-700">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                MCQ Multiple Answers Reading Response Analysis
              </h3>
                  ...
                  {explanationParagraphs.map(
                    (paragraph: string, index: number) => (
                      <div
                        ...
                        className="rounded-xl px-4 py-2 text-sm leading-relaxed text-gray-700 dark:border-blue-500/10 dark:bg-gray-900/40 dark:text-gray-300"
                      >
                        {paragraph}
                      </div>
                    ),
