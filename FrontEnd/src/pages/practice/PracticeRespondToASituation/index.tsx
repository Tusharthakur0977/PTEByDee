...
const PracticeRespondToASituation = () => {
          ...
          <div>
            ...
            <div className="flex flex-row items-center space-x-3 ">
              ...
              <p className="font-bold text-blue-600 dark:text-blue-400 text-sm leading-relaxed">
                ...
                10 seconds to think about your answer. Then you will hear a
                beep. You will have 40 seconds to answer the question.
              </p>
            </div>
          </div>
        </div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <div className="relative group inline-flex items-center">
                                  ...
                                  <div className="absolute left-full top-1/2 ml-3 -translate-y-1/2 w-64 p-3 bg-gray-900 text-white text-xs rounded-xl shadow-xl hidden group-hover:block z-50">
                                    ...
                                    {component === "content" &&
                                      "Content is scored by determining whether your response addresses the situation appropriately and includes relevant explanation, reassurance, or justification. Missing key intent or giving an unsuitable response will reduce your score."}
...
export default PracticeRespondToASituation;
