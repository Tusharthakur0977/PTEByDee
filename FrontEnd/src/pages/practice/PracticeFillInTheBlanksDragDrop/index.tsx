...
const PracticeFillInTheBlanksDragDrop: React.FC = () => {
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div className="relative group inline-flex items-center">
                                ...
                                <div className="absolute left-full top-1/2 ml-3 -translate-y-1/2 w-64 p-3 bg-gray-900 text-white text-xs rounded-xl shadow-xl hidden group-hover:block z-50">
                                  ...
                                  <p>
                                    Your response for Reading: Fill in the
                                    Blanks (Drag and Drop) is judged on your
                                    ability to use context and grammatical cues
                                    to identify words that complete a reading
                                    text. If all blanks are filled correctly,
                                    you receive the maximum score points for
                                    this question type. If one or more blanks
                                    are filled incorrectly, partial credit
                                    scoring applies.
                                  </p>
...
export default PracticeFillInTheBlanksDragDrop;
