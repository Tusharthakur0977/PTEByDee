...
const PracticeSelectMissingWord: React.FC = () => {
  ...
  const loadQuestions = useCallback(async () => {
    try {
      ...
      const response = await getPracticeQuestions(
        PteQuestionTypeName.SELECT_MISSING_WORD,
        options,
      );
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const result = await api.post('/user/questions/submit-response', {
        ...
        userResponse: {
          selectedWord: response.selectedWord,
        },
          ...
          <div>
            ...
            <div className='flex flex-row items-center space-x-3 '>
              <p className='font-bold text-blue-600 dark:text-blue-400 text-sm leading-relaxed'>
                You will hear a recording about fiction writing. At the end of
                the recording the lost word or group of words has been replaced
          ...
          <div className='max-w-4xl mx-auto p-8 space-y-6'>
            ...
            <div className='space-y-3'>
              ...
              {currentQuestion?.content?.options?.map((option) => {
                ...
                const isSelected = response.selectedWord === option.id;
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <button
                onClick={handleReset}
                disabled={isSubmitting || !response.selectedWord}
              ...
              {!isCompleted && (
                <button
                  ...
                  disabled={!response.selectedWord || isSubmitting}
                              ...
                              <div className='relative group inline-flex items-center'>
                                ...
                                <div className='absolute left-full top-1/2 ml-3 -translate-y-1/2 w-64 p-3 bg-gray-900 text-white text-xs rounded-xl shadow-xl hidden group-hover:block z-50'>
                                  ...
                                  <p>
                                    ...
                                    speaker will say, based on contextual clues
                                    in a recording. Your response is scored as
                                    either correct or incorrect. No credit is
                                    given for no response or an incorrect
                                    response.
                                  </p>
                      ...
                      evaluationResult.evaluation.detailedAnalysis.choiceResult
                        ...
                        <div className='bg-white dark:bg-gray-800 rounded-lg border border-blue-200 dark:border-blue-800 overflow-hidden'>
                          ...
                          <div className='p-6 space-y-3'>
                            {evaluationResult.evaluation.detailedAnalysis.choiceResult.selectedTexts.map(
