...
const ResponseDetailModal: React.FC<ResponseDetailModalProps> = ({
  ...
  const correctSelectionCount = response.isCorrect ? 1 : 0;
  const incorrectSelectionCount = incorrectlySelectedTexts.length;
          ...
          <div className="flex items-start justify-between gap-4 border-b border-gray-200 px-6 py-4 dark:border-gray-700">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                Select Missing Word Response Analysis
              </h3>
          ...
          <div className="p-6">
            <div className="max-h-[70vh] space-y-6 overflow-y-auto overscroll-contain pr-1">
              ...
              {renderChoiceList(
                ...
                "No selected word was recorded for this attempt.",
              )}
              ...
              {renderChoiceList(
                ...
                "Correct word is not available for this attempt.",
                "success",
              )}
              ...
              {!response.isCorrect &&
                ...
                renderChoiceList(
                  ...
                  "No incorrect word was selected.",
                  "danger",
                )}
