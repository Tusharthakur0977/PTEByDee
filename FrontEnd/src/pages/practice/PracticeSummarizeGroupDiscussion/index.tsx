...
const PracticeSummarizeGroupDiscussion: React.FC = () => {
  ...
  const triggerRecordingFlow = useCallback(() => {
    clearPrepTimer();
    setPrepTimeLeft(0);
  ...
  useEffect(() => {
    if (isAudioFinished && !isCompleted && !isAudioReady) {
      const prepDuration = 10;
      setPrepTimeLeft(prepDuration);
    ...
    return () => clearPrepTimer();
  }, [isAudioFinished, currentIndex, isCompleted, isAudioReady, questions]);
          ...
          <div>
            ...
            <div className='flex flex-row items-center space-x-3 '>
              ...
              <p className='font-bold text-blue-600 dark:text-blue-400 text-sm leading-relaxed'>
                You will hear people having a discussion. When you hear the
                beep, summarize the whole discussion. You will have 10 seconds
                to prepare and 2 minutes to give your response.
              </p>
            </div>
          </div>
        </div>
                ...
                >
                              ...
                              <div className='flex items-center gap-2'>
                                ...
                                <div className='relative group inline-flex items-center'>
                                  ...
                                  <div className='absolute left-full top-1/2 ml-3 -translate-y-1/2 w-64 p-3 bg-gray-900 text-white text-xs rounded-xl shadow-xl hidden group-hover:block z-50'>
                                    ...
                                    {component === 'content' &&
                                      'Content is scored by determining how accurately and thoroughly you summarize the main points of the group discussion. The best responses capture the key viewpoints, agreements or disagreements, and the overall outcome or direction of the discussion.'}
                  ...
                  {evaluationResult.evaluation.detailedAnalysis?.userText && (
                    <div className='rounded-3xl border border-slate-200 bg-white shadow-[0_18px_60px_rgba(15,23,42,0.08)] dark:border-slate-700/70 dark:bg-slate-900/80 dark:shadow-[0_18px_60px_rgba(15,23,42,0.24)]'>
                      ...
                      <div className='p-5'>
                        <div className='rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 text-base leading-8 text-slate-900 dark:border-slate-700/70 dark:bg-slate-950 dark:text-slate-100'>
...
export default PracticeSummarizeGroupDiscussion;
