...
const PracticeListeningFillInTheBlanks: React.FC = () => {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    const filledBlanks = Object.values(response.blanks || {}).filter(
      (val) => val && val.trim(),
    ).length;
                        ...
                        {index < array.length - 1 && (
                          <span className="inline-block relative mx-1">
                            {isCompleted ? (
                              ...
                              // Input mode - editable text field
                              <input
                                type="text"
                                value={userAnswer}
                                onChange={(e) =>
                            ...
                            {/* Show correct answer label if incorrect */}
                            {isCompleted && !isCorrect && (
                              <span className="text-rose-600 dark:text-rose-400 text-sm font-semibold ml-1">
                              ...
                              <div className="relative group inline-flex items-center">
                                ...
                                <div className="absolute left-full top-1/2 ml-3 -translate-y-1/2 w-64 p-3 bg-gray-900 text-white text-xs rounded-xl shadow-xl hidden group-hover:block z-50">
                                  ...
                                  <p>
                                    ...
                                    for Fill in the Blanks is judged on your
                                    ability to listen for missing words in a
                                    recording and type the missing words into a
                                    transcription. Your score on Fill in the
                                    blanks is based on the following factor:
                                  </p>
