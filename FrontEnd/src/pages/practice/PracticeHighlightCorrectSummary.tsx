  ...
  return (
    <div className='h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex flex-col'>
      ...
      <div className='bg-gray-800 border-b border-gray-700 px-6 py-4 flex justify-between items-center'>
        <div>
          <h1 className='text-2xl font-bold text-white'>Highlight Correct Summary</h1>
      ...
      <div className='flex-1 overflow-auto p-8'>
        <div className='max-w-4xl mx-auto'>
          ...
          {/* Question */}
          <div className='bg-gray-700 rounded-lg p-8 mb-8 border border-gray-600'>
            <h3 className='text-white font-semibold mb-4'>Select the correct summary:</h3>
          </div>
            ...
            {currentQuestion.options?.map((option: any) => (
              ...
              >
                <input
                  ...
                  name='summary'
                  value={option.id}
                  checked={selectedSummary === option.id}
                  onChange={(e) => {
          ...
          <button
            ...
            disabled={!selectedSummary || isSubmitting}
