        ...
        <div className='container mx-auto px-4'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center'>
            ...
            <div className='relative mt-8 lg:mt-0'>
              ...
              />
              <div className='absolute -bottom-4 -left-4 sm:-bottom-6 sm:-left-6 bg-white text-gray-900 p-4 sm:p-6 rounded-xl shadow-xl'>
      ...
      <section className='py-20 bg-white dark:bg-gray-900'>
        <div className='container mx-auto px-4'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center'>
            <div>
              <h2 className='text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-8'>
            ...
            <div className='relative mt-8 lg:mt-0'>
              <img
                ...
                className='rounded-2xl shadow-2xl'
              />
              <div className='absolute top-4 right-4 sm:top-6 sm:right-6 bg-blue-600 text-white p-3 sm:p-4 rounded-xl shadow-lg'>
