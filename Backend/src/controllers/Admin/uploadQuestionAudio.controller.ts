...
/**
 * @desc    Upload question audio to S3
 * @route   POST /api/admin/upload/question-audio
 * @access  Private/Admin
 */
export const uploadQuestionAudio = asyncHandler(
    ...
    try {
      ...
      if (!req.file) {
        return sendResponse(
          ...
          null,
          'No audio file provided. Please select an audio file to upload.'
        );
      }
      ...
      return sendResponse(
        ...
        {
          audioKey: uploadedFile.key, // Store this in your database
          audioUrl: previewUrl, // Use this for immediate preview (optional)
      ...
      console.error('Upload question audio error:', error);
